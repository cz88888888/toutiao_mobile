<template>
  <div class="article-container">
    <!-- 导航栏 -->
    <van-nav-bar @click-left="$router.back()" class="page-nav-bar" left-arrow title="世界头条"></van-nav-bar>
    <!-- /导航栏 -->
    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <van-cell class="user-info" center :border="false">
          <van-image class="avatar" slot="icon" round fit="cover" :src="article.art_photo" />
          <div slot="title" class="user-name">{{article.aut_name}}</div>
          <div slot="label" class="publish-date">{{article.pubdate | relativeTime}}</div>
          <!-- <follow-user :is-followed="article.is_followed" :user-id="article.aut_id" @update-is_followed="article.is_followed = $event" /> -->
          <!-- 上面的简写 传给子组件的数据既要用又要该，用v-model -->
